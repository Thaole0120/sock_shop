...
# Our "database" of sock products - in memory collection of the products
socks = {
    1: {
        'id': 1,
        'name': 'Meme Lord',
...
# then adds them to the index.html file that serves as the template for the home page.
...
# for the current ession ( browser session) and the total cost
@app.route('/cart')
def cart():
    cart = session.get('cart', [])
